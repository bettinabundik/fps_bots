...
namespace FPSbots
{
    ...
    public class AgentData
    {
        ...
        public AgentData(Int32 _id, Int32 _it, Position _pos, Action _action, Int32 _timestamp)
        {
            id = _id;
            iteration = _it;
    ...
    public class Statistics
    {
        ...
        public void UpdateStats(Int32 agentid, Boolean collision, Double newdistance, Boolean item, Int32 iteration, Position pos, Action action, Int32 timestamp)
        {
            ...
            else
            {
                ...
                agentdata.Add(new AgentData(agentid, iteration, new Position(pos.X, pos.Y), action, timestamp));
            }
        }
